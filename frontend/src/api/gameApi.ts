...
export const gameApi = {
  ...
  migrate: (id: number, destination_habitat_id: number, population_fraction: number) => post<PlayerAction>(`/species/${id}/migrate`, { destination_habitat_id, population_fraction }),
